<?php
	  ...
	  $client_lang['12'] = "Deleted successfully...";

	  $client_lang['13'] = "Enabled successfully...";

	  $client_lang['14'] = "Disabled successfully...";

	  $client_lang['15'] = "Feature enabled successfully...";

	  $client_lang['16'] = "Feature disabled successfully...";
	  
	  $client_lang['17'] = "Notification sent successfully...";

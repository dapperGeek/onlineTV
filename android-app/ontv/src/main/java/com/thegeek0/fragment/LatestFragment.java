...
public class LatestFragment extends Fragment {
    ...
    private GetLatestItemTask getLatestItemTask = null;
    ...
    private void getLatestItem() {
        if (Build.VERSION.SDK_INT >= 24){
            ...
            getLatestItemTask = new GetLatestItemTask();
            getLatestItemTask.execute();
        }
    }

    private void doGetLatestItems(){
    ...
    public class GetLatestItemTask extends AsyncTask<String, String, JSONObject> {
...
//                params.put("featured", "featured");
                ...
                //make post
                JSONObject json = jsonParser.makeHttpRequest(Constant.LATEST_URL, "GET", params);

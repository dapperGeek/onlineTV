...
public class SearchFragment extends Fragment {
    ...
    String search;
    GetSearchItemTask getSearchItemTask = null;
    ...
    private void getSearchItem() {
        if (Build.VERSION.SDK_INT >= 24){
            ...
            getSearchItemTask = new GetSearchItemTask(search);
            getSearchItemTask.execute();
        }
    }
    ...
    public class GetSearchItemTask extends AsyncTask<String, String, JSONObject> {
        private String search;

        JSONParser jsonParser = new JSONParser();

        //task constructor
        GetSearchItemTask(String search){
            this.search = search;
        }
